...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        /* YOUR CODE HERE */
    	//System.out.println("new valuex is "+that.x+" old valye is "+x+" and the diff is "+(that.x-x));
    	//System.out.println("new valuey is "+that.y+" old valye is "+y+ " and the diff is "+(that.y-y));
    	if(that.y==y)
    	{
    		if(that.x!=x)
    			return 0;
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
    	Point p = new Point(107,154);
    	Point q = new Point(107,154);
    	Point r = new Point(259,181);
